...
<?php
                                        ...
                                        $result5 = $connect->query($sql5);
										 ...
										 $c++;
											...
											<?php
													$d=0;
                                         $sql6="SELECT * FROM tbl_applied_jobs WHERE `status`= 1";
                                        $result6 = $connect->query($sql6);
										 ...
										 $d++;
											...
											<?php
													$e=0;
                                         $sql7="SELECT * FROM tbl_applied_jobs WHERE `status`= 0";
...
var data = google.visualization.arrayToDataTable([
  ['Data', 'Count'],
  ['Applied Jobs',<?php echo $a ?>],
  ['Approved Jobs',<?php echo $b ?>],
  ['Appl. Sent',<?php echo $c ?>],
  ['Hired',<?php echo $d ?>],
  ['Rejected',<?php echo $e ?>]
]);
...
var chart = new google.visualization.BarChart(document.getElementById('myChart'));
  chart.draw(data, options);
								...
								<?php
                                        ...
                                        $result8 = $connect->query($sql8);
										 ...
										 $l++;
                                            ...
                                            ?>
									<div class="card-body">
										<p class="text-black mb-0">Number of Users</p>
										<span class="fs-28 text-black font-w600 mb-5 d-block"><?php echo $l ?></span>
										<div class="d-flex align-items-center">
								...
								<?php
                                        ...
                                        $result7 = $connect->query($sql7);
										 ...
										 $e++;
                                            ...
                                            ?>
									<div class="card-body">
										<p class="text-black mb-0">Rejected</p>
										<span class="fs-28 text-black font-w600 mb-5 d-block"><?php echo $e ?></span>
										<div class="d-flex align-items-center">
											<svg class="min-w42 me-3" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="col-xl-4 col-xxl-6 col-lg-4 col-sm-6">
								<div class="card">
									...
									<div class="card-body">
										...
										<span class="fs-28 text-black font-w600 mb-5 d-block"><?php echo $d ?></span>
										<div class="d-flex align-items-center">
											<svg class="min-w42 me-3 primary-icon" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed & Developed : Aljo Biju</p>
            </div>
        </div>
        <!--**********************************
            Footer end
